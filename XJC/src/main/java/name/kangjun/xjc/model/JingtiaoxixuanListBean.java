...
public class JingtiaoxixuanListBean {
    ...
    private int type;
    private int end;
    private List<JingtiaoxixuanItemBean> data;
    ...
    public List<JingtiaoxixuanItemBean> getData() {
        return data;
    }

    public void setData(List<JingtiaoxixuanItemBean> data) {
        this.data = data;
    }
}
