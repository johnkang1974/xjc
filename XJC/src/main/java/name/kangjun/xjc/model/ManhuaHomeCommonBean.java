...
public class ManhuaHomeCommonBean {
    ...
    private int code;
    private String msg;
    private ManhuaHomeCommonListBean data;
    ...
    public ManhuaHomeCommonListBean getData() {
        return data;
    }

    public void setData(ManhuaHomeCommonListBean data) {
        this.data = data;
    }
}
